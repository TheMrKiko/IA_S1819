...
S�o usadas as seguintes fun��es cujo c�digo n�o foi publicado:

1) xx_invalid_solution(<board>, <result of search>)
   A fun��o devolve False se o resultado da procura estiver correcto.
   Sen�o a fun��o devolve uma mensagem de erro que tenta mostrar o que falhou.
   Por exemplo:
    ...
    - "O tabuleiro nao tem s� um pino: <board>"
